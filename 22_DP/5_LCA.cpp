...
#include<vector>
using namespace std;
int lcaRec(string str1, string str2){
    ...
    if(str1[n-1] == str2[m-1]){
        return 1 + lcaRec(str1.substr(0, n-1), str2.substr(0, m-1));
    }
    else{
        int ans1 = lcaRec(str1.substr(0, n-1), str2);
        int ans2 = lcaRec(str1, str2.substr(0, m-1));
